...
\hline%
Autotune&0.1837&12.2474&13.3271\\%
\hline%
...
\hline%
IAE optimized&0.4000&2337.2940&953.8600&0.0441\\%
\hline%
\end{tabular}%
...
\begin{subfigure}{0.25\textwidth}%
\centering%
\includegraphics[width=\linewidth]{closed_loop_cascade_setpoint.png}%
\subcaption{Setpoint response}%
\end{subfigure}%
\begin{subfigure}{0.25\textwidth}%
\centering%
...
\hline%
IAE optimized&0.4000&2337.2940&953.8600&1.8478\\%
\hline%
\end{tabular}%
...
\hline%
Setpoint&13.3271&4.1578&{-}9.1692\\%
\hline%
\end{tabular}%
...
\begin{tabular}{cccc}%
\hline%
$y_i$&$u_j$&$\Lambda_{ij}$&$|\Lambda_{ij}-1|$\\%
\hline%
y1&u1&1.2500&0.2500\\%
\hline%
y2&u2&1.2500&0.2500\\%
...
\[%
G_{11}{\left(s \right)} = \frac{5 e^{- 5 s}}{4 s + 1} \quad G_{12}{\left(s \right)} = \frac{2 e^{- 4 s}}{8 s + 1} \quad G_{21}{\left(s \right)} = \frac{3 e^{- 3 s}}{12 s + 1} \quad G_{22}{\left(s \right)} = \frac{6 e^{- 3 s}}{10 s + 1}%
\]%
\begin{table}[H]%
\centering%
...
\begin{align*}%
D_{12}{\left(s \right)} = \frac{2 \left(4 s + 1\right) e^{s}}{5 \left(8 s + 1\right)} \\%
D_{21}{\left(s \right)} = \frac{10 s + 1}{2 \left(12 s + 1\right)}%
\end{align*}%
The term%
$\ e^{s} \ $%
in D12 is noncausal because it is equivalent to a negative delay. I will treat it as a delay and use a Pade approximation to make it realizable. The resulting approximated D12 is shown below.%
\par%
\[%
D_{12}{\left(s \right)} = \frac{2 \left(1.0 s + 2.0\right) \left(4 s + 1\right)}{5 \left(2.0 - 1.0 s\right) \left(8 s + 1\right)}%
\]%
\begin{table}[H]%
\centering%
\begin{tabular}{ccc}%

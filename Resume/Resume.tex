...
\begin{itemize}
  ...
  % --- Optional Computational / Materials bullets ---
...
\begin{itemize}
  ...
  \item Modeled heater/process systems to ensure safe and efficient operation under variable conditions.
\end{itemize}
...
\begin{itemize}
  ...
  \item Performed lab-scale TFF membrane filtration and AKTA chromatography experiments to support pilot- and manufacturing-scale development.
  % --- Optional Biopharma / Analytical bullets ---
  % \item Trained technicians on GMP protocols and protein handling procedures.
\end{itemize}
...
\textbf{Relevant Coursework:} Advanced Process Engineering, Polymer Chemistry, Polymer Engineering & & 
\end{tabularx}
%========================
%\section{Projects}

...
\par%
\[%
K_{c,1} = 3604932548414123070440737630846976.0000, \qquad \tau_{I,1} = 207034715.1867, \qquad I_1 = 0.0000%
\]%
\begin{table}[H]%
\centering%
\begin{tabular}{cccc}%
...
\par%
\[%
K_{c,1} = 50365186339204098824734525882368.0000, \qquad \tau_{I,1} = 1883000003466100998144.0000, \qquad I_1 = 0.0000%
\]%
\begin{table}[H]%
\centering%
\begin{tabular}{ccccc}%

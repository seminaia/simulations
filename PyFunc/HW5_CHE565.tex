...
\\%
\[%
e^{- s \theta_{d}} = \frac{2.0 - 1.0 s}{1.0 s + 2.0}%
\]%
...
.%
\par%
Case 1: Step disturbance with no setpoint change gave and step in disturbance with no setpoint change gave IAE = 37305.9383 in Python and IAE = 725.8109 in Simulink.%
\par%
\begin{figure}[H]%
\centering%
...
\par%
Case 2: Step disturbance with no setpoint change and PI autotuning gave IAE = 13.0796 in Python and IAE = 13.0463 in Simulink.%
\par%
\begin{figure}[H]%
\centering%
\begin{subfigure}{0.45\textwidth}%
...
.%
\par%
Case 3: Step setpoint change with no disturbance change gave IAE = 130209.8077 in Python and IAE = 2450.8205 in Simulink.%
\par%
\begin{figure}[H]%
\centering%
\begin{subfigure}{0.45\textwidth}%
...
.%
\par%
Case 4: Step setpoint change with no disturbance change and PI autotuning gave IAE = 9.7272 in Python and IAE = 8.1939 in Simulink.%
\par

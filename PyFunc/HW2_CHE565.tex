...
\par%
\[%
\text{Annual payment for option A:}\ \text{P}_A = \$492,117.38/\text{year},\quad \text{Annual payment for option B:}\ \text{P}_B = \$647,522.87/\text{year}%
\]
...
\hline%
$x_{2}^{2} + \left(x_{1} - x_{2}\right)^{2}$&$\left[\begin{matrix}2 & -2\\-2 & 4\end{matrix}\right]$&$\left[\begin{matrix}3 - \sqrt{5}\\\sqrt{5} + 3\end{matrix}\right]$&Yes&Eigenvalues are positive\\%
\hline%
$x_{1}^{2} + x_{2}^{2} + x_{3}^{2}$&$\left[\begin{matrix}2 & 0 & 0\\0 & 2 & 0\\0 & 0 & 2\end{matrix}\right]$&$\left[\begin{matrix}2\end{matrix}\right]$&Yes&Eigenvalues are positive\\%
\hline%

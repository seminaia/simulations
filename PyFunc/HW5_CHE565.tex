...
IAE = 725.7464 in Python and IAE = 725.8109 in Simulink.%
...
\end{figure}%
Case 2: Step disturbance with no setpoint change and PI autotuning gave %
IAE = 13.0420 in Python and IAE = 13.0463 in Simulink.%
...
\end{figure}%
Case 3: Step setpoint change with no disturbance change gave %
IAE = 2443.4231 in Python and IAE = 2450.8205 in Simulink.%
...
\end{figure}%
Case 4: Step setpoint change with no disturbance change and PI autotuning gave IAE = 8.1947 in Python and IAE = 8.1939 in Simulink. The response is shown in %

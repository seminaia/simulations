...
\]%
\[%
D_{12}{\left(s \right)} = \frac{2 \left(4 s + 1\right) e^{s}}{5 \left(8 s + 1\right)} \quad D_{21}{\left(s \right)} = \frac{10 s + 1}{2 \left(12 s + 1\right)}%
\]%
\begin{table}[H]%
\centering%
...
The term%
$\ e^{s} \ $%
in D12 is noncausal because it is equivalent to a negative delay. %

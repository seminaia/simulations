...
%
The response of the closed{-}loop system is shown in Figure%
$\ref{fig:fig1}$%
for the nominal PI settings obtained from the%
InlineMathToken(latex='\textbackslash{}\textbackslash{}quad \textbackslash{}\textbackslash{}lambda \textbackslash{}\textbackslash{}text\{{-}rules.\}')%
\par
...
%
\textbackslash{}text\{The response of the closed{-}loop system is shown in Figure\} \textbackslash{}ref\{fig:fig2\}.%
\par
...
%
For the doubled controller gain, the setpoint response is shown in Figure%
$\ref{fig:fig3}$%
...
%
For the halved controller gain, the setpoint response is shown in Figure%
$\ref{fig:fig5}$%
and the disturbance response is shown in Figure%
$\ref{fig:fig6}$%
\par%

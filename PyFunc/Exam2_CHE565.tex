...
\begin{figure}[H]%
\includegraphics[width=0.95\textwidth,keepaspectratio]{problem1_basic_feedback_diagram.png}%
\caption{Basic feedback control diagram.}%
\end{figure}
...
\par%
\begin{align*}%
G_{actual}(s)=\frac{0.8}{s(2s+1)(5s+1)} \\%
G_{model}(s)=\frac{0.75}{s}e^{-4s} \\%
...
\par%
\begin{align*}%
IAE_{setpoint,basic} = 31.9746 \\%
IAE_{disturbance,basic} = 971.9761%
\end{align*}%
...
\begin{align*}%
K_{c,inner} = 50.0000 \\%
IAE_{setpoint,cascade} = 30.2838 \\%
IAE_{disturbance,cascade} = 19.4403%
\end{align*}

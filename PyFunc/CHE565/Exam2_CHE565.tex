...
\centering%
\includegraphics[width=\linewidth]{Exam2_plots/Exam2_block_diagram_setpoint.png}%
\subcaption{Setpoint step response}%
\end{subfigure}%
\begin{subfigure}{0.45\textwidth}%
\centering%
\includegraphics[width=\linewidth]{Exam2_plots/Exam2_block_diagram_disturbance.png}%
...
\begin{subfigure}{0.45\textwidth}%
\centering%
\includegraphics[width=\linewidth]{Exam2_plots/problem1_basic_setpoint.png}%
\subcaption{Setpoint step}%
\end{subfigure}%
\begin{subfigure}{0.45\textwidth}%
\centering%
\includegraphics[width=\linewidth]{Exam2_plots/problem1_basic_disturbance.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.95\textwidth,keepaspectratio]{Exam2_plots/problem1_cascade_diagram.png}%
...
\begin{subfigure}{0.45\textwidth}%
\centering%
\includegraphics[width=\linewidth]{Exam2_plots/problem1_cascade_setpoint.png}%
\subcaption{Cascade setpoint step}%
\end{subfigure}%
\begin{subfigure}{0.45\textwidth}%
\centering%
\includegraphics[width=\linewidth]{Exam2_plots/problem1_cascade_disturbance.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.95\textwidth,keepaspectratio]{Exam2_plots/problem2_feedforward_diagram.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.95\textwidth,keepaspectratio]{Exam2_plots/problem3_mimo_diagram.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.95\textwidth,keepaspectratio]{Exam2_plots/problem3_decoupled_mimo_diagram.png}%

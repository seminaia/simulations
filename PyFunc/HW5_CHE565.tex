...
\begin{figure}[h]%
\includegraphics[width=0.8\linewidth,height=0.5\textheight,keepaspectratio]{HW5_CHE565_block_diagram.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{closed_loop_no_cascade_simulink.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{closed_loop_no_cascade.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{closed_loop_no_cascade_autotuning_python.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{closed_loop_no_cascade_simulink_autotuning.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{closed_loop_no_cascade_setpoint.png}%
...
%
Next, the response to a unit step change in setpoint with no disturbance change was simulated. The Python response is shown in %
Figure~\ref{fig:no_cascade_setpoint}%
.%
\par%


\begin{figure}[H]%
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{closed_loop_no_cascade_setpoint_simulink.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{closed_loop_no_cascade_setpoint_simulink_autotuning.png}%
...
\begin{figure}[H]%
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{closed_loop_no_cascade_setpoint_autotuning.png}%
...
Figure~\ref{fig:no_cascade_setpoint_autotuning}%
.%
\par

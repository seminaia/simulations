...
Materials and process engineer with experience in process optimization, manufacturing support, statistical process control, SOP development,  Lean/Six Sigma principles. Skilled in process scale-up, troubleshooting, CAPA implementation, and cross-team technical transfer. Proficient in data-driven analysis and modeling to improve process performance and product quality, with strong hands-on experience in lab and pilot-scale operations. Very Familiar with various scientific computing tools including Python, MATLAB/Simulink, ASPEN Plus Dynamics, and R for data analysis and process modeling.
...
\begin{itemize}
  ...
  \item Performed lab-scale TFF membrane filtration, UF/DF, and AKTA chromatography resin life-time studies to validate CIP protocols.
...
\end{tabularx}
\textbf{Relevant Coursework:}  Advanced Process Engineering, Polymer Chemistry, Polymer Engineering, Heat and Mass Transfer, Fluid Mechanics, Separation Processes, Advanced Thermodynamics
%========================
%\section{Projects}
...
\textbf{Process / Manufacturing:} & SPC, DOE, Lean/Six Sigma (Certification in progress), Process optimization, SOP development, Tech Transfer (MSAT), cGMP \\
\end{tabularx}

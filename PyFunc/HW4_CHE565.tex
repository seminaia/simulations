...
\subsection*{Controller Design using \$\textbackslash{}lambda\${-}Rules}%
...
\par%
\subsection*{1. Controller Settings from the \textbackslash{}lambda{-}Rules}%
...
\]%
The response of the closed{-}loop system is shown in Figure \textbackslash{}ref\{fig:part3\_disturbance\_nominal\}.%
\par%
...
\end{align*}%
For the doubled controller gain, the setpoint response is shown in Figure \$\textbackslash{}ref\{fig:part4\_setpoint\_kc\_double\}\$, and the disturbance response is shown in Figure \textbackslash{}ref\{fig:part4\_disturbance\_kc\_double\}.%
\par%
...
\end{align*}%
For the halved controller gain, the setpoint response is shown in Figure \textbackslash{}ref\{fig:part4\_setpoint\_kc\_half\}, and the disturbance response is shown in Figure \textbackslash{}ref\{fig:part4\_disturbance\_kc\_half\}.%
\par%
...
%
A direct comparison of the gain variations is shown in Figures \textbackslash{}ref\{fig:compare\_kc\_setpoint\} and \textbackslash{}ref\{fig:compare\_kc\_disturbance\}.%
\par%
...
\end{align*}%
The corresponding setpoint and disturbance responses are shown in Figures \textbackslash{}ref\{fig:part5\_setpoint\_tauI\_large\} and \textbackslash{}ref\{fig:part5\_disturbance\_tauI\_large\}.%
\par%
...
\end{align*}%
The corresponding setpoint and disturbance responses are shown in Figures \textbackslash{}ref\{fig:part5\_setpoint\_tauI\_small\} and \textbackslash{}ref\{fig:part5\_disturbance\_tauI\_small\}.%
\par%
...
%
A direct comparison of the integral time constant variations is shown in Figures \textbackslash{}ref\{fig:compare\_tauI\_setpoint\} and \textbackslash{}ref\{fig:compare\_tauI\_disturbance\}.%
\par%

...
\begin{align*}%
\text{Present Value formula:}\ PV &= \frac{F \cdot \left(r + 1\right)^{- n} \cdot \left(\left(r + 1\right)^{n} - 1\right)}{r} \\%
\text{Net Present Value formula:}\ \text{NPV} &= C_{0} + \frac{F \cdot \left(r + 1\right)^{- n} \cdot \left(\left(r + 1\right)^{n} - 1\right)}{r} \\%
\text{Annual payment formula:}\ P &= \frac{C_{0} \cdot r \cdot \left(r + 1\right)^{n}}{\left(r + 1\right)^{n} - 1}%
\end{align*}%
\[%
...
\hline%
$e^{x_{1}} + e^{x_{2}}$&$\left[\begin{matrix}e^{x_{1}} & 0\\0 & e^{x_{2}}\end{matrix}\right]$&$\left[\begin{matrix}e^{x_{1}}\\e^{x_{2}}\end{matrix}\right]$&Yes&Eigenvalues are positive\\%
\hline%
\end{tabular}%
\end{table}

...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.95\textwidth,height=0.95\textheight]{HW5_CHE565_block_diagram.png}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.95\textwidth,height=0.95\textheight]{closed_loop_no_cascade_simulink.png}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.95\textwidth,height=0.95\textheight]{closed_loop_no_cascade.png}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.95\textwidth,height=0.95\textheight]{closed_loop_no_cascade_autotuning_python.png}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.95\textwidth,height=0.95\textheight]{closed_loop_no_cascade_simulink_autotuning.png}%

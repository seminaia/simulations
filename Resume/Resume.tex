...
\begin{itemize}
  ...
  \item Performed lab-scale TFF membrane filtration and AKTA chromatography resin life-time studies to validate CIP protocols.
...
\textbf{Minors:} Chemistry, Physics & & \\[3pt]
\end{tabularx}
\textbf{Relevant Coursework:}  Advanced Process Engineering, Polymer Chemistry, Polymer Engineering, Heat and Mass Transfer, Fluid Mechanics, Separations Processes
%========================
%\section{Projects}
...
\textbf{Scientific Computing:} & Python, MATLAB/Simulink, ASPEN Plus Dynamics, Linux, LaTeX, R, Unicorn \\
\textbf{Laboratory / Analytical:} & Glovebox, clean-room, HPLC, AKTA FPLC, TFF, SEM/XRD, DSC/TGA, UV-Vis, Osmometry, HPLC/MS, GC/MS, pH meter, SDS-PAGE, KF coulometric titration \\
